...
##Format
  ...
  particular format. The format is as follows, 
    1. Row 1: The first row in the file must contain the number of elements being permuted, e.g. '5' for the permutations of the
    numbers 1, 2, 3, 4, and 5.
    2.All subsequent rows: Each subsequent row in the file can either be blank (for whatever reason) or contain a permutation
